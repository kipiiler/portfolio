...
![[Pasted image 20240730202529.png]]
{/* $$\text{Relationship between \# of strips and max length of all strips v.s. cache size}$$ */}
### Code examples
...
int main() {
    ...
    std::vector<unsigned int> indices = { /* your indices here */ };

    // Configure stripification constraints
    NVTRISTRIP::SetCacheSize(16); // Example cache size
    NVTRISTRIP::SetListsOnly(false);
    NVTRISTRIP::SetStitchStrips(false);
